            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('updateCategory') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="categoryName" type="text" class="form-control" name="categoryName" value={{ $formData->name}} required autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name ="parentCategory" class="form-control">
                                    <option @if( $formData->parent == null) selected @endif value="0">None</option>
                                    @if($categories->count() > 0)
                                        @foreach($categories as $category)
                                            <option 
                                                value={{ $category['id'] }} 
                                                @if($category['id'] == $formData->parent) 
                                                selected @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sortOrder" type="number" class="form-control" name="sortOrder" value={{ $formData->sortOrder }} min="0" required autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name ="status" class="form-control">
                                    <option @if($formData->status == 1) 
                                                selected @endif value="1">Enabled</option>
                                    <option @if($formData->status == 0) 
                                                selected @endif value="0">Disabled</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
